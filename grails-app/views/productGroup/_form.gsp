<%@ page import="com.omnitech.chai.model.ProductGroup" %>
			...
			<div class="${hasErrors(bean: productGroupInstance, field: 'parent', 'error')} ">
				...
				<div>
					<g:select class="form-control" style="width: 50%;" id="parent" name="parent.id" from="${otherGroups}" optionKey="id" value="${productGroupInstance?.parent?.id}" class="many-to-one"/>
