<table>
    <tr>
            ...
            <div class="form-inline">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <select class="form-control" ng-model="group.binOperator" style="padding-right: 11px; padding-left: 11px;">
                            <option>and</option>
                            <option>or</option>
                        </select>
                    </div>
        ...
        <td>
            ...
            <div ng-repeat="cnd in group.conditions" class="form-inline">
                <div class="form-group">
            ...
            <div ng-repeat="group in group.groups" ng-include="'${myTemplate}'">{{data.name}}</div>
        </td>
    </tr>
</table>