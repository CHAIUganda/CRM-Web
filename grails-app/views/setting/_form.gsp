<%@ page import="com.omnitech.chai.model.Setting" %>
			...
			<div class="${hasErrors(bean: settingInstance, field: 'name', 'error')} ">
				...
				<div>
					<g:textField class='form-control' style="width: 50%;" name="name" value="${settingInstance?.name}" />
			...
			<div class="${hasErrors(bean: settingInstance, field: 'value', 'error')} ">
				...
				<div>
					<g:textField class='form-control' style="width: 50%;" name="value" value="${settingInstance?.value}" />
