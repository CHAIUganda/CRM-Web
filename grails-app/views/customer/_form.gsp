...
<div class="${hasErrors(bean: customerInstance, field: 'outletName', 'error')} ">
    ...
    <div>
        <g:textField class='form-control' style="width: 50%;" name="outletName"
...
<div class="${hasErrors(bean: customerInstance, field: 'outletType', 'error')} ">
    ...
    <div>
        <g:select class='form-control' style="width: 50%;" name="outletType" from="${customerInstance?.constraints?.outletType?.inList}"
...
<div class="${hasErrors(bean: customerInstance, field: 'buildingStructure', 'error')} ">
    ...
    <div>
        <g:textField class='form-control' style="width: 50%;" name="buildingStructure"
...
<div class="${hasErrors(bean: customerInstance, field: 'descriptionOfOutletLocation', 'error')} ">
    ...
    <div>
        <g:textField class='form-control' style="width: 50%;" name="descriptionOfOutletLocation"
...
<div class="${hasErrors(bean: customerInstance, field: 'equipment', 'error')} ">
    ...
    <div>
        <g:textField class='form-control' style="width: 50%;" name="equipment" value="${customerInstance?.equipment}"/>
...
<div class="${hasErrors(bean: customerInstance, field: 'keyWholeSalerContact', 'error')} ">
    <label for="keyWholeSalerContact" class="control-label"><g:message code="customer.keyWholeSalerContact.label"
                                                                       default="Key Whole Saler Contact"/></label>

    <div>
        <g:textField class='form-control' style="width: 50%;" name="keyWholeSalerContact"
...
<div class="${hasErrors(bean: customerInstance, field: 'keyWholeSalerName', 'error')} ">
    ...
    <div>
        <g:textField class='form-control' style="width: 50%;" name="keyWholeSalerName"
...
<div class="${hasErrors(bean: customerInstance, field: 'lat', 'error')} ">
    ...
    <div>
        <g:field class='form-control' style="width: 50%;" type="number" name="lat" value="${customerInstance.lat}"/>
        <span class="help-inline alert-danger">${hasErrors(bean: customerInstance, field: 'lat', 'error')}</span>
    </div>
</div>

<div class="${hasErrors(bean: customerInstance, field: 'latLng', 'error')} ">
    <label for="latLng" class="control-label"><g:message code="customer.latLng.label" default="Lat Lng"/></label>

    <div>
        <g:textField class='form-control' style="width: 50%;" name="latLng" value="${customerInstance?.latLng}"/>
        <span class="help-inline alert-danger">${hasErrors(bean: customerInstance, field: 'latLng', 'error')}</span>
    </div>
</div>
...
<div class="${hasErrors(bean: customerInstance, field: 'lng', 'error')} ">
    ...
    <div>
        <g:field class='form-control' style="width: 50%;" type="number" name="lng" value="${customerInstance.lng}"/>
...
<div class="${hasErrors(bean: customerInstance, field: 'majoritySourceOfSupply', 'error')} ">
    <label for="majoritySourceOfSupply" class="control-label"><g:message code="customer.majoritySourceOfSupply.label"
                                                                         default="Majority Source Of Supply"/></label>

    <div>
        <g:textField class='form-control' style="width: 50%;" name="majoritySourceOfSupply"
...
<div class="${hasErrors(bean: customerInstance, field: 'numberOfBranches', 'error')} ">
    ...
    <div>
        <g:field class='form-control' style="width: 50%;" type="number" name="numberOfBranches"
...
<div class="${hasErrors(bean: customerInstance, field: 'numberOfCustomersPerDay', 'error')} ">
    <label for="numberOfCustomersPerDay" class="control-label"><g:message code="customer.numberOfCustomersPerDay.label"
                                                                          default="Number Of Customers Per Day"/></label>

    <div>
        <g:field class='form-control' style="width: 50%;" type="number" name="numberOfCustomersPerDay"
...
<div class="${hasErrors(bean: customerInstance, field: 'numberOfEmployees', 'error')} ">
    ...
    <div>
        <g:field class='form-control' style="width: 50%;" type="number" name="numberOfEmployees"
...
<div class="${hasErrors(bean: customerInstance, field: 'numberOfProducts', 'error')} ">
    ...
    <div>
        <g:field class='form-control' style="width: 50%;" type="number" name="numberOfProducts"
...
<div class="${hasErrors(bean: customerInstance, field: 'openingHours', 'error')} ">
    ...
    <div>
        <g:textField class='form-control' style="width: 50%;" name="openingHours"
...
<div class="${hasErrors(bean: customerInstance, field: 'outletSize', 'error')} ">
    ...
    <div>
        <g:textField class='form-control' style="width: 50%;" name="outletSize"
...
<div class="${hasErrors(bean: customerInstance, field: 'split', 'error')} ">
    ...
    <div>
        <g:textField class='form-control' style="width: 50%;" name="split" value="${customerInstance?.split}"/>
...
<div class="${hasErrors(bean: customerInstance, field: 'tenureEndDate', 'error')} ">
    <label for="tenureEndDate" class="control-label"><g:message code="customer.tenureEndDate.label"
                                                                default="Tenure End Date"/></label>

    <div>
        <g:datePicker name="tenureEndDate" precision="day" value="${customerInstance?.tenureEndDate}"/>
        <span class="alert alert-warning">${hasErrors(bean: customerInstance, field: 'tenureEndDate', 'error')}</span>
    </div>
</div>
...
<div class="${hasErrors(bean: customerInstance, field: 'turnOver', 'error')} ">
    <label for="turnOver" class="control-label"><g:message code="customer.turnOver.label" default="Turn Over"/></label>

    <div>
        <g:field class='form-control' style="width: 50%;" type="number" name="turnOver"
...
<div class="${hasErrors(bean: customerInstance, field: 'uuid', 'error')} ">
    <label for="uuid" class="control-label"><g:message code="customer.uuid.label" default="Uuid"/></label>

    <div>
        <g:textField class='form-control' style="width: 50%;" name="uuid" value="${customerInstance?.uuid}"/>
        <span class="help-inline alert-danger">${hasErrors(bean: customerInstance, field: 'uuid', 'error')}</span>
    </div>
</div>
