<div id="legend" class="col-md-2" style="background: #ffffff;">
    ...
    <div class="row">
        <div class="col-sm-1 btn" style="background: #e41a1c; height: 20px;"
             ng-click="onLegendFilter('t.dueDays <= -2')"></div>

        <div class="col-sm-8" style="padding-left: 0;padding-right: 0;"
             ng-click="onLegendFilter('t.dueDays <= -2')">Outstanding</div>
    </div>
    ...
    <div class="row" ng-click="onLegendFilter('t.dueDays >= 7 && t.type == \'task\'')">
