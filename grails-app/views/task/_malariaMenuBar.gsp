...
<div class="container" style="max-width: 100%; padding: 0; margin-bottom: 3px;">
    <div class="container"
        ...
        <ul id="Menu" class="nav nav-pills margin-top-small">
            ...
            %{-- TASK LIST--}%
            <li class="${params.action == "malaria" ? 'active' : ''}">
                <g:link action="malaria" params="${[status: 'new']}"><i class="glyphicon glyphicon-th-list"></i> ${entityName}s</g:link>
            </li>
            ...
            <li>
                ...
                <ul role="menu" class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                    <g:each in="${users}" var="u">
                        <li><g:link action="${params.action == 'map' ? 'map' : 'malaria'}"
                ...
                <li>
                    ...
                    <ul role="menu" class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                        <g:if test="${params.user != null}">
                            <li>
                                <g:link action="${params.action == 'map' ? 'map' : 'malaria'}"
        ...
        %{--The Export Button--}%
            <g:if test="${params.user != null}">
                <li>
                    <g:link action="exportMalaria" params="${[user: params.user]}">
