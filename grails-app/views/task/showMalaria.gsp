...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'task.label', default: 'Malaria Forms')}"/>
...
<section id="show-task" class="first">
    ...
    <table class="table">
        ...
        <g:render template="/task/showMalariaDetails"/>

        </tbody>
    </table>
    <g:if test="${taskInstance?.detailerMalariaStocks}">
        <g:render template="/task/malariaStock"/>
    </g:if>
</section>
